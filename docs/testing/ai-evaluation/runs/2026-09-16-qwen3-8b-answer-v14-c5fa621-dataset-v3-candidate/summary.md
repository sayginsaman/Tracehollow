...
- Generated: 2026-09-16T21:13:57.749911+00:00
...
3. **Citation validity:** 95 stored citations, 0 failing verification; model references rejected by the validator {}; claims removed {'no_verified_citation': 1, 'subject_not_in_cited_evidence': 4, 'value_not_in_cited_evidence': 1}. Cross-case leakage questions 0; cloud requests from the local-only case 0.
...
| q03 | development | supported_fact | partially_answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓ |  |
...
| n06 | holdout | time_scope | insufficient_evidence | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, no_forbidden_text ✗ | forbidden text present: ['99.1'] |
...
| n09 | holdout | conflict | partially_answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓, conflict_preserved ✓, conflict_labelled ✓ |  |
