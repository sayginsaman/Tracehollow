...
- Generated: 2026-09-16T17:15:26.049142+00:00
...
1. **Question-level automated checks:** 52/55 questions pass every automated check (development 32/33; holdout 12/14; regression 8/8); numeric agreement 8/8.
2. **Answering and abstention:** answerable questions 35/37 answered, 2 unnecessary abstention(s) ['q23', 'n09']; unanswerable questions 13/14 abstained, 1 answered without support ['n02'].
3. **Citation validity:** 75 stored citations, 0 failing verification; model references rejected by the validator {'rejected_quote_not_found': 6}; claims removed {'conflict_without_two_verified_sources': 2, 'no_verified_citation': 7, 'number_not_in_database_result': 2, 'subject_not_in_cited_evidence': 5, 'value_not_in_cited_evidence': 2}. Cross-case leakage questions 0; cloud requests from the local-only case 0.
...
| q06 | development | turkish | partially_answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓ |  |
...
| q23 | development | conflict | insufficient_evidence | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✗, cites_expected_evidence ✗, conflict_preserved ✗, conflict_labelled ✗ | status insufficient_evidence not in ['answered', 'partially_answered'] |
...
| n02 | holdout | subject_applicability | partially_answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✗, no_forbidden_text ✓ | status partially_answered not in ['insufficient_evidence'] |
...
| n07 | holdout | time_scope | partially_answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓ |  |
...
| n09 | holdout | conflict | insufficient_evidence | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✗, cites_expected_evidence ✗, conflict_preserved ✗, conflict_labelled ✗ | status insufficient_evidence not in ['answered', 'partially_answered'] |
...
| n11 | holdout | partial_coverage | partially_answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓, no_forbidden_text ✓ |  |
