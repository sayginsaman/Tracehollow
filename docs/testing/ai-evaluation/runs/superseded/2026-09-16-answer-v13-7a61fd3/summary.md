...
- Generated: 2026-09-16T02:57:14.599462+00:00
...
- Prompt templates: plan-v2, answer-v13
...
2. **Answering and abstention:** answerable questions 36/37 answered, 0 unnecessary abstention(s) []; unanswerable questions 14/14 abstained, 0 answered without support [].
3. **Citation validity:** 83 stored citations, 0 failing verification; model references rejected by the validator {}; claims removed {'conflict_without_two_verified_sources': 1, 'no_verified_citation': 1, 'subject_not_in_cited_evidence': 4, 'value_not_in_cited_evidence': 1}. Cross-case leakage questions 0; cloud requests from the local-only case 0.
...
| q24 | development | conflict | output_truncated | run_completed ✗, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✗, cites_expected_evidence ✗, conflict_preserved ✗, conflict_labelled ✗ | run failed: output_truncated; status None not in ['answered', 'partially_answered'] |
