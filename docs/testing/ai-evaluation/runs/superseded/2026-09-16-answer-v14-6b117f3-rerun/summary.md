...
- Generated: 2026-09-16T18:06:08.588991+00:00
...
1. **Question-level automated checks:** 54/55 questions pass every automated check (development 32/33; holdout 14/14; regression 8/8); numeric agreement 8/8.
2. **Answering and abstention:** answerable questions 36/37 answered, 1 unnecessary abstention(s) ['q03']; unanswerable questions 14/14 abstained, 0 answered without support [].
3. **Citation validity:** 88 stored citations, 0 failing verification; model references rejected by the validator {'rejected_quote_not_found': 1}; claims removed {'no_verified_citation': 2, 'subject_not_in_cited_evidence': 5, 'value_negated_in_cited_evidence': 1, 'value_not_in_cited_evidence': 2}. Cross-case leakage questions 0; cloud requests from the local-only case 0.
...
| q24 | development | conflict | answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓, conflict_preserved ✓, conflict_labelled ✓ |  |
...
| h05 | regression | conflict | partially_answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓, conflict_preserved ✓, conflict_labelled ✓ |  |
...
| n03 | holdout | subject_applicability | answered | run_completed ✓, citations_valid ✓, no_cross_case_leakage ✓, expected_status ✓, cites_expected_evidence ✓ |  |
