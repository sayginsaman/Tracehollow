...
const MESSAGES: Record<string, string> = {
  ...
  account_not_found: "No active account has that username.",
  member_not_found: "That account is not a member of this case.",
  current_password_invalid: "The current password is incorrect.",
  monitor_not_found: "The monitor does not exist in this case.",
  change_set_not_found: "The change set does not exist in this case.",
  notification_not_found: "The notification does not exist or is no longer available to you.",
  destination_not_found: "The notification destination does not exist.",
  subscription_not_found: "The subscription does not exist.",
  evidence_expired_by_retention: "This evidence was removed by the case retention policy.",
